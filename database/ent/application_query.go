...
func (aq *ApplicationQuery) QueryUserID() *UserQuery {
...
func (aq *ApplicationQuery) Clone() *ApplicationQuery {
	...
	return &ApplicationQuery{
		...
		withUserID: aq.withUserID.Clone(),
...
func (aq *ApplicationQuery) WithUserID(opts ...func(*UserQuery)) *ApplicationQuery {
	query := (&UserClient{config: aq.config}).Query()
...
func (aq *ApplicationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Application, error) {
	...
	if query := aq.withUserID; query != nil {
		if err := aq.loadUserID(ctx, query, nodes, nil,
			func(n *Application, e *User) { n.Edges.UserID = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *ApplicationQuery) loadUserID(ctx context.Context, query *UserQuery, nodes []*Application, init func(*Application), assign func(*Application, *User)) error {
